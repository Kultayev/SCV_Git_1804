...
## Передача изменений/дополнений в удаленный репозиторий на Github, pull request.
После внесения дополнений/изменений в удаленный форкнутый репозиторий Github, можно отправить автору свой вариант работы через команду  
```
pull request
```  
Все изменения рекомендуется выполнять в отдельной ветке

После обновления на GitHub отобразиться список веток, далее можно выбрать какую из них загрузить/залить кнопкой
